 ...
 * under the License.
 */
package org.apache.jackrabbit.oak.plugins.index.lucene.mt;
...
public class MTFulltextQueryTermsProviderFactory implements FulltextQueryTermsProvider {
    ...
    public void activate(Map<String, ?> config) throws Exception {
        ...
        try {
            ...
            joshuaConfiguration.readConfigFile(pathToJoshuaConfig);
            ...
            queryTermsProvider = new MTFulltextQueryTermsProvider(decoder, nodeTypes);
        } catch (Exception e) {
