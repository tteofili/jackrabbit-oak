 ...
 *
 */
public class LuceneIndexOld implements AdvanceFulltextQueryIndex {

    private static final Logger LOG = LoggerFactory
            .getLogger(LuceneIndexOld.class);
    ...
    public LuceneIndexOld(IndexTracker tracker, NodeAggregator aggregator) {
        ...
        Iterator<LuceneResultRow> itr = new AbstractIterator<LuceneResultRow>() {
            ...
            private boolean loadDocs() {
                ...
                try {
                    ...
                    LOG.warn("query via {} failed.", LuceneIndexOld.this, e);
                } finally {
                    indexNode.release();
                }
            ...
            private void checkForIndexVersionChange(IndexSearcher searcher) {
                long currentVersion = LuceneIndex.getVersion(searcher);
    ...
    private static LuceneRequestFacade getLuceneRequest(Filter filter, IndexReader reader, boolean nonFullTextConstraints,
        ...
        return LuceneIndex.performAdditionalWraps(qs);
    }
    ...
    private static void addNonFullTextConstraints(List<Query> qs,
        ...
        for (PropertyRestriction pr : filter.getPropertyRestrictions()) {
            ...
            if (IndexHelper.skipTokenization(name)) {
