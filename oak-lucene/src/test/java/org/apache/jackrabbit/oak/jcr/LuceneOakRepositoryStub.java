    ...
    private static class LuceneCompatModeInitializer extends LuceneInitializerHelper {
        ...
        public void initialize(@Nonnull NodeBuilder builder) {
            if (builder.hasChildNode(INDEX_DEFINITIONS_NAME)
                ...
                index.child(FulltextIndexConstants.SUGGESTION_CONFIG)
                        .setProperty(JCR_PRIMARYTYPE, "nt:unstructured", NAME)
                        .setProperty(FulltextIndexConstants.SUGGEST_UPDATE_FREQUENCY_MINUTES, 10);
                ...
                ntBase.setProperty(FulltextIndexConstants.INDEX_NODE_NAME, true);
