...
public interface OakSolrConfiguration {
     ...
     *
     * @return a {@link org.apache.jackrabbit.oak.plugins.index.solrNew.configuration.OakSolrConfiguration.CommitPolicy}
     */
    @Nonnull
     ...
     *
     * @return <code>true</code> if {@link org.apache.jackrabbit.oak.plugins.index.solrNew.query.SolrQueryIndex} should be used
