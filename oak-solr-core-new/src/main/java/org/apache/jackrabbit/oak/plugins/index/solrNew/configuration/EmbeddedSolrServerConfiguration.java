 ...
 */
package org.apache.jackrabbit.oak.plugins.index.solrNew.configuration;

import org.apache.jackrabbit.oak.plugins.index.solrNew.configuration.EmbeddedSolrServerConfiguration;
import org.apache.jackrabbit.oak.plugins.index.solrNew.configuration.SolrServerConfiguration;
...
public class EmbeddedSolrServerConfiguration extends SolrServerConfiguration<EmbeddedSolrServerProvider> {
    ...
    /**
     * get the {@link org.apache.jackrabbit.oak.plugins.index.solrNew.configuration.EmbeddedSolrServerConfiguration.HttpConfiguration} holding parameters for enabling Solr
     * server with HTTP bindings
     *
     * @return a {@link org.apache.jackrabbit.oak.plugins.index.solrNew.configuration.EmbeddedSolrServerConfiguration.HttpConfiguration} or <code>null</code> if not set
     */
