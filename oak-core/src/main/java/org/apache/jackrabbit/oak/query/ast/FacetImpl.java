 ...
 * Support for "facet(...)
 */
public class FacetImpl extends ConstraintImpl {

    private final Logger log = LoggerFactory.getLogger(getClass());

    public static final String NATIVE_LUCENE_LANGUAGE = "lucene";

    public static final String FACET_PREFIX = "facet?fields=";

    private final String selectorName;
    private final StaticOperandImpl expression;
    private SelectorImpl selector;

    FacetImpl(String selectorName, StaticOperandImpl expression) {
    ...
    public void restrict(FilterImpl f) {
        if (f.getSelector().equals(selector)) {
            ...
            String query = FACET_PREFIX + term;
